...
class PaymentChannelsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\PaymentChannel::updateOrCreate(['id' => 17], ['title' => 'Payhere', 'class_name' => 'Payhere', 'status' => 'active', 'image' => '/assets/default/img/charge/paytu.png', 'settings' => '', 'created_at' => time()]);
    }
}
